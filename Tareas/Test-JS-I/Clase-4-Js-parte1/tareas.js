...
function agregarNumeros(numeros) {
  ...
  // Tu código:
  return numeros.reduce((accumulador, valorActual)=> accumulador + valorActual)
}
...
function promedioResultadosTest(resultadosTest) {
  ...
  // Tu código:
  let promedio = 0;
  promedio = resultadosTest.reduce((acc, cv,)=> acc + cv)/resultadosTest.length;
  return promedio;
}
